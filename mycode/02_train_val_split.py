...
obj_train, obj_val = train_test_split(object_images, test_size=0.2, random_state=42)

# 객체 없는 이미지도 8:2 분할
noobj_train, noobj_val = train_test_split(no_object_images, test_size=0.2, random_state=42)
...
# 저장
with open('/home/cv/jw/AUE8088/datasets/kaist-rgbt/train.txt', 'w') as f:
    f.writelines('\n'.join(train_list) + '\n')
with open('/home/cv/jw/AUE8088/datasets/kaist-rgbt/val.txt', 'w') as f:
    f.writelines('\n'.join(val_list) + '\n')
